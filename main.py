...
def main(config_dict):   
    ...
    random_seed = 42
    dataset = data_loader.keypoint_dataset(dataset_path, output_res ,train = is_train,  normalize=True, jitter=True, canonical=True)
    ...
    print("valid_indices: ", len(val_indices))
    ...
    if(is_evaluate != -1):
        ...
        #print("model_weights", type(model_weights))
    ...
    if(is_train != -1):
        ...
        torch.save(model.state_dict(), "hour_glass/model.pth")
        logger.close()
